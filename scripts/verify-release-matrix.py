...
REQUIRED_MAIN_SOURCE_SNIPPETS = [
    ...
    "agent_writer_round_robins_non_priority_frames_inside_burst",
    "transport_writer_round_robins_non_priority_frames_inside_burst",
    "output_producer_yield_budget_yields_after_bounded_data_frames",
    "AgentCreditWindow",
    ...
    "AGENT_CARRIER_READ_BUFFER_BYTES",
    "carrier_read_buffer_matches_frame_payload_target",
    "RUSTLE_SSH_CHANNEL_WINDOW_BYTES",
    "RUSTLE_SSH_MAX_PACKET_BYTES",
    "rustle_ssh_client_config_uses_data_plane_sized_channels",
    "BridgeEventAccounting",
    ...
    "bridge_event_batch_is_bounded_by_remote_bytes",
    ...
    "quic-auth: transport=quic-native",
    "quic-connect: transport=quic-native",
    "quic-agent-protocol: transport=quic-agent",
    "timed out writing QUIC helper auth acknowledgement",
    "QUIC_DATA_PLANE_CONNECT_TIMEOUT: Duration = Duration::from_secs(15)",
    ...
    "total_bytes_max",
    "remote_backlog_high_water_survives_flush",
    "UnixShutdownSignal",
    "SignalKind::hangup",
...
REQUIRED_RELEASE_NOTE_SNIPPETS = [
    ...
    "8 MiB chunked-response `agent` throughput gate",
...
REQUIRED_ARCHITECTURE_NOTE_SNIPPETS = [
    ...
    "starts with a 4 MiB receive window",
    "bounded 24 MiB cap",
    "64 MiB SSH channel window",
    "256 KiB max packet",
    "credit_window_grows_after_sustained_full_window_consumption",
...
REQUIRED_LIVE_BENCH_SNIPPETS = [
    ...
    "RUSTLE_BENCH_REQUIRE_AUTO_QUIC_FALLBACK",
...
REQUIRED_LIVE_FIXTURE_SNIPPETS = [
    ...
    "RUSTLE_FIXTURE_ALLOW_CONTROL_HOST",
    "RUSTLE_FIXTURE_ALLOW_LOCAL_HOST",
    "RUSTLE_FIXTURE_SKIP_REMOTE_CLEANUP_CHECK",
    "reject_fixture_control_host",
    "ssh_remote_lookup_host",
    'parse_ssh_remote "$REMOTE"',
    "reject_fixture_local_host",
    "RUSTLE_FIXTURE_HOST resolves to SSH control host",
    "RUSTLE_FIXTURE_HOST resolves to client-local address",
    ...
    "remote uploaded agent cleanup left artifact(s)",
    "awk '/^READY / { print $3 }'",
...
REQUIRED_QUIC_DIAGNOSTIC_SUMMARY_SNIPPETS = [
    ...
    "auto-quic-decision:",
    "STRUCTURED_AUTH_RE",
    "STRUCTURED_CONNECT_RE",
    "PROTOCOL_RE",
    "AUTO_QUIC_DECISION_RE",
    "result_status",
...
REQUIRED_LIVE_DIAGNOSIS_SUMMARY_SNIPPETS = [
    ...
    "hotpath_pressure",
    "agent_remote_output_credit_pressure",
    "agent_remote_output_send_pressure",
    "supervisor_remote_event_pressure",
    "agent_send_credit_pressure",
    "agent_send_outbound_pressure",
...
REQUIRED_LIVE_SMOKE_SNIPPETS = [
    ...
    "auto-quic needs distinct quic-bridge-agent and agent helper commands",
    "BRIDGE_EVENT_QUEUE_REMOTE_BYTES",
...
REQUIRED_QUIC_AGENT_SMOKE_SNIPPETS = [
    ...
    "--agent-sessions 1",
    "quic-agent: connecting UDP data plane role=quic-agent",
    "quic-agent-protocol: transport=quic-agent",
    "bootstrap_port=",
    "resolved_addrs=",
...
REQUIRED_PERFORMANCE_NOTE_SNIPPETS = [
    ...
    "bridge_event_queue=remote_bytes",
    "backlog_bytes=<n> max:<n> raw:<n> max_raw:<n>",
    "remote_backlog_bytes_max",
    "remote_bytes_raw",
    "max_raw",
    "bridge_event_queue_remote_bytes_max",
    ...
    "fresh SSH connection with one exec channel",
    "sustained streams adapt up to a bounded 24 MiB cap",
