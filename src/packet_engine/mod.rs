...
#[cfg(test)]
pub(crate) use udp::{
    apply_udp_ingress_action, apply_udp_ingress_actions, drop_unsupported_direct_udp,
    plan_udp_datagram_actions, UdpDropReason,
};
pub(crate) use udp::{
...
mod tests {
    ...
    use crate::transport_model::{
        bridge_admission_decision, BridgeAdmissionDecision, BridgeAdmissionLimits, UdpAssociation,
        UdpAssociationEvents, UdpFlowKey, MAX_AGENT_ACTIVE_STREAMS, MAX_AGENT_OPENING_STREAMS,
